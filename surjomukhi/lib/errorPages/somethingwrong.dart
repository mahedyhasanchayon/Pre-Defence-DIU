...
import 'package:surjomukhi/main.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SvgPicture.asset("assets/images/wrong.svg",height:158.0 ,width:158.0 ),
            SizedBox(height:64.0),
            Text("Something went wrong",textAlign: TextAlign.center,style: GoogleFonts.poppins(fontSize: 18.0,fontWeight: FontWeight.w600,color: Color(0xFF000000))),
