...
import 'package:surjomukhi/errorPages/somethingwrong.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SvgPicture.asset("assets/images/error.svg",height:158.0 ,width:158.0 ),
            SizedBox(height:64.0),
            Text("Error",textAlign: TextAlign.center,style: GoogleFonts.poppins(fontSize: 18.0,fontWeight: FontWeight.w600,color: Color(0xFF000000))),
            ...
            GestureDetector(
              onTap: ()=> Navigator.of(context).push(MaterialPageRoute(builder: ((context) => SomethingWrong())),),
              child: Container(
                height:55.0 ,
                width: 225.0,
